...
(doom! :input
       ;;bidi              ; (tfw) multilingual setup
       ;;chinese
       ;;japanese
       ;;layout            ; auie, dotspacemacs, dvorak...
       ...
       :checkers
       (syntax +icons) ; native error/warning linting via flymake
       ...
       (lsp)        ; lightweight and built-in LSP client
       magit               ; a git porcelain for Emacs
       ;;make              ; run make tasks from Emacs
       ;;pass              ; password manager for nerds
       pdf                 ; pdf enhancements
       ;;prodigy           ; FIXME Manage external services & code builders
